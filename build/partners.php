            ...
            <div class="tabs__content-items-el docs-tabs-reverse tabs__header tabmenu-slider-wrapper">
                <div class="swiper-container tabmenu-slider tabmenu-slider--year js-tabmenu-slider">
                    <ul class="swiper-wrapper">
                        ...
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2018">2018</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2017">2017</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2016">2016</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2015">2015</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2014">2014</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2013">2013</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2012">2012</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2011">2011</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2010">2010</a>
                        </li>
                        <li class="swiper-slide">
                            <a class="tabs__header-item tabmenu-slider__link js-tab-link" href="javascript:;" data-rel="tab-2009">2009</a>
                        </li>
                        <li class="swiper-slide">
                    ...
                    <div class="row">
                        <div class="col col-12 col-sm-6">
                            <a href="javascript:;" class="info-card info-card_doc">
                                ...
                                <div class="info-card__fileInfo">
                                    <div class="info-card__fileInfo-size">56 КБ</div>
                        ...
                        <div class="col col-12 col-sm-6">
                            <a href="javascript:;" class="info-card info-card_doc">
                                ...
                                <div class="info-card__fileInfo">
                                    <div class="info-card__fileInfo-size">48 КБ</div>
                                    <div class="info-card__fileInfo-fileType">PDF</div>
                                </div>
                            </a>
                        </div>
            ...
            <div class="row info-card-wrapper">
                <div class="col col-6 col-lg-4">
                    <a href="javascript:;" class="info-card info-card_doc info-card--report">
                        ...
                        <div class="info-card__fileInfo">
                            <div class="info-card__fileInfo-size">2 МБ</div>
                            <div class="info-card__fileInfo-fileType">PDF</div>
                        </div>
                    </a>
                </div>
                <div class="col col-6 col-lg-4">
                    <a href="javascript:;" class="info-card info-card_doc info-card--report">
                        ...
                        <div class="info-card__fileInfo">
                            <div class="info-card__fileInfo-size">459 КБ</div>
                            <div class="info-card__fileInfo-fileType">PDF</div>
                        </div>
                    </a>
                </div>
